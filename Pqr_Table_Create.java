...
public class Pqr_Table_Create {
	
	//public static void main(String[] args)throws Exception {
			public Pqr_Table_Create()throws Exception{
			// TODO Auto-generated method stub
			Class.forName("com.mysql.cj.jdbc.Driver");
			
			Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3307/omkar","root","");
			
			String q="CREATE TABLE pqr_group (  id int(30),username varchar(255),phone_no varchar(255))";
